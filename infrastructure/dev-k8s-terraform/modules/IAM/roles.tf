...
resource "aws_iam_instance_profile" "profile_for_master_1" {
  name  = var.profile_for_master_1
  role = aws_iam_role.role_for_master.name
}

resource "aws_iam_instance_profile" "profile_for_worker_1" {
  name  = var.profile_for_worker_1
